...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    super.initState();
    loadGares();
    loadTypeObject();  // Assurez-vous que cette fonction est appelée ici
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            if (gares.isNotEmpty) // Affiche le menu déroulant des gares seulement si les données sont prêtes
            ...
            if (typeObjects.isNotEmpty) // Affiche le menu déroulant des types seulement si les données sont prêtes
              DropdownButton<String>(
            ...
            ElevatedButton(
              onPressed: () {
                if (selectedGare != null && selectedTypeObject != null) {
                  print('Gare sélectionnée: $selectedGare'); // Débogage
                  print('Type d\'objet sélectionné: $selectedTypeObject'); // Débogage
                  setState(() {
